...
Future<void> initDI() async {
  try {
    ...
    instance.registerLazySingleton<TabNavigator>(() => TabNavigator(instance.get()));

    instance.registerLazySingleton<AuthExternalNavigator>(() => AuthExternalNavigatorImpl(appRouter: instance.get()));
    instance.registerLazySingleton<HomeExternalNavigator>(() => HomeExternalNavigatorImpl(
